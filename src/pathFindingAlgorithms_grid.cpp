...
#include "heuristicFunctions_grid.h"
...
std::tuple<int, int, int, std::vector<std::vector<std::array<int, 2>>>> dijkstraSingleTarget(std::array<int, 2> source, std::array<int, 2> target, int gridRow, int gridCol, MainFrame *mainFramePtr, wxGrid *gridPtr, bool showAnimation)
{
...
std::tuple<int, int, int, std::vector<std::vector<std::array<int, 2>>>> aStarSearch(std::array<int, 2> source, std::array<int, 2> target, int gridRow, int gridCol, MainFrame *mainFramePtr, wxGrid *gridPtr, bool showAnimation)
{
    // VARIABLLE DECLARATION
    std::vector<std::vector<int>> minTravelCost(gridRow, std::vector<int>(gridCol, INT_MAX));
...
std::tuple<int, int, int, std::vector<std::vector<std::array<int, 2>>>> greedyBestFirstSearch(std::array<int, 2> source, std::array<int, 2> target, int gridRow, int gridCol, MainFrame *mainFramePtr, wxGrid *gridPtr, bool showAnimation)
{
    // VARIABLLE DECLARATION
    std::vector<std::vector<int>> minTravelCost(gridRow, std::vector<int>(gridCol, INT_MAX));
    std::vector<std::vector<int>> distanceTravelled(gridRow, std::vector<int>(gridCol, INT_MAX));
...
std::tuple<int, int, int, std::vector<std::vector<std::array<int, 2>>>> bfs(std::array<int, 2> source, std::array<int, 2> target, int gridRow, int gridCol, MainFrame *mainFramePtr, wxGrid *gridPtr, bool showAnimation)
{
    // VARIABLLE DECLARATION
    std::vector<std::vector<std::array<int, 2>>> prev(gridRow, std::vector<std::array<int, 2>>(gridCol, {-1, -1}));
    std::vector<std::vector<int>> visited(gridRow, std::vector<int>(gridCol, false));
...
std::tuple<int, int, int, std::vector<std::vector<std::array<int, 2>>>> bidirectionalBFS(std::array<int, 2> source, std::array<int, 2> target, int gridRow, int gridCol, MainFrame *mainFramePtr, wxGrid *gridPtr, bool showAnimation)
{
    // VARIABLLE DECLARATION
